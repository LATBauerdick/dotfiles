...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
          ...
          /* CTL_ESC, NAV_A,   KC_R,    KC_S,    KC_T,    KC_G,    KC_SCLN, KC_M,    KC_N,    KC_E,    KC_I,    KC_O   ,          XXXXXXX, */
 /* KC_LSFT, LSF_Z  , LSF_Z  , KC_X,    KC_C,    KC_D,    KC_V,    KC_SLSH, KC_K,    KC_H,    KC_COMM, KC_DOT,           RSF_ENT, ADJ_ENT, */
          ...
          CTL_ESC, NAV_A,   KC_R,    KC_S,    KC_T,    KC_D,    KC_SCLN, KC_H,    KC_N,    KC_E,    KC_I,    KC_O   ,          XXXXXXX,
 ...
 _______, _______, _______,          _______,          KC_BSPC,          _______,          _______, KC_BRMD, KC_VOLD, KC_VOLU, KC_BRMU
    ...
    [_ADJ] = LAYOUT(
          ...
          _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, COLEMAK, QWERTY , _______, _______, RESET  ,
